...
function monospace_cart_styles() {
    echo '<style>
        ...
        /* Count wrapper (absolute anchor point) */
        .monospace-cart-count-wrapper {
            position: absolute;
            top: -4px;          /* nudged slightly outward for visual balance */
            right: -4px;
            width: 20px;
            height: 20px;
            pointer-events: none;
        ...
        .monospace-cart-count {
            ...
            border-radius: 50%; /* guarantees circle */
            ...
            /* remove padding so shape cannot become oval */
            padding: 0;
        }
